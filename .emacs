...
(custom-set-variables
 ...
 ;;   (quote
 ;;    (ein ein-mumamo ipython-shell-send anaconda-mode elpy org-capture-pop-frame afternoon-theme borland-blue-theme calmer-forest-theme challenger-deep-theme color-theme-sanityinc-solarized cyberpunk-theme dakrone-theme distinguished-theme doneburn-theme dracula-theme eclipse-theme espresso-theme exotica-theme latex-preview-pane epl flycheck font-lock+ memoize org pkg-info tablist xml-rpc xml+ xml-quotes xmlgen pretty-mode pretty-symbols auctex-lua writeroom-mode prettify-greek ample-zen-theme arjen-grey-theme atom-dark-theme auto-complete badger-theme blackboard-theme cheatsheet darcula-theme darkroom darktooth-theme haskell-mode html-to-markdown auctex-latexmk paradox abyss-theme airline-themes alect-themes atom-one-dark-theme badwolf-theme ebib tex-smart-umlauts textmate toxi-theme typit typo underwater-theme org2blog ox-hugo auto-dictionary cdlatex latex-extra latex-math-preview latex-unicode-math-mode markdown-mode org-edit-latex captain)))
...
p;; ; activate all the packages (in particular autoloads)
;; (package-initialize)
